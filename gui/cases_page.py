...
class ScanDetailDialog(QDialog):
    ...
    def _badge(self, severity: str) -> QWidget:
        """Compact severity pill — aligned with other columns."""
        colors = {
            "High": ("#fecaca", "#991b1b"),
        ...
        # Compact widths so Risk column stays tight
        if severity == "Medium":
    ...
    def _make_findings_table(self, findings: list) -> QTableWidget:
        ...
        # Narrower Risk column — badges are compact now
...
class CasesPage(QWidget):
    ...
    def _load_scans_for_case(self, case_id: int):
        ...
        for i, row in enumerate(scans):
            ...
            # Text % instead of QProgressBar — avoids double-click / focus issues
